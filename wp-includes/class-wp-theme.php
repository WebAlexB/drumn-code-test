...
final class WP_Theme implements ArrayAccess {
		...
		if ( ! $this->template ) {
			...
			if ( ! $this->is_block_theme() && ! file_exists( $theme_path . '/index.php' ) ) {
				$error_message = sprintf(
					/* translators: 1: template/index.html, 2: index.php, 3: Documentation URL, 4: Template, 5: style.css */
	 ...
	 *
	 * @since 4.7.0
	 * @since 5.8.0 Include block template.
	 *
	...
	public function is_block_theme() {
		...
		$paths_to_index_block_template = array(
			$this->get_file_path( '/template/index.html' ),
			$this->get_file_path( '/block-template/index.html' ),
		);
	...
	public function get_block_template_folders() {
		...
		if ( file_exists( $stylesheet_directory . '/block-template' ) || file_exists( $stylesheet_directory . '/block-template-parts' ) ) {
			$this->block_template_folders = array(
				'wp_template'      => 'block-template',
