...
/**
 * Controller which provides REST endpoint for exporting current template
 * and template parts.
 *
 * @since 5.9.0
 *
...
class WP_REST_Edit_Site_Export_Controller extends WP_REST_Controller {
	...
	public function permissions_check() {
		...
		return new WP_Error(
			...
			__( 'Sorry, you are not allowed to export template and template parts.' ),
			array( 'status' => rest_authorization_required_code() )
		);
	}

	/**
	 * Output a ZIP file with an export of the current template
