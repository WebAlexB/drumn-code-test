...
function switch_theme( $stylesheet ) {
	 ...
	 * context to ensure template will be loaded from the new theme.
	 */
 ...
 *
 * Standalone themes need to have a `template/index.html` or `index.php` template file.
...
function validate_current_theme() {
	...
	if (
		! file_exists( get_template_directory() . '/template/index.html' )
		&& ! file_exists( get_template_directory() . '/block-template/index.html' ) // Deprecated path support since 5.9.0.
 ...
 * @since 5.8.0 The `block-template` feature indicates whether a theme uses block-based template.
 ...
 *
 * @since 5.5.0
 * @since 6.0.1 The `block-template` feature was added.
 */
function create_initial_theme_features() {
	...
	register_theme_feature(
		'block-template',
		array(
			'description'  => __( 'Whether a theme uses block-based template.' ),
			'show_in_rest' => true,
		)
	);
	register_theme_feature(
