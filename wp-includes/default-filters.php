 ...
 * also conditionally enabled when a site has custom template. Block Theme
 * template can be available for every post type.
 */
...
// Block template post type and rendering.
