...
class Theme_Upgrader extends WP_Upgrader {
	...
	public function check_package( $source ) {
		 ...
		 * - block themes require /template/index.html or block-template/index.html (deprecated 5.9.0).
		 */
		if (
			empty( $info['Template'] ) &&
			! file_exists( $working_directory . 'index.php' ) &&
			! file_exists( $working_directory . 'template/index.html' ) &&
			! file_exists( $working_directory . 'block-template/index.html' )
		) {
			return new WP_Error(
